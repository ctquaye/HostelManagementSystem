<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student.aspx.cs" Inherits="HostelManagementSystem.student" %>
...
<div class="wrapper">
    ...
    ProviderName="System.Data.SqlClient" 
            InsertCommand="INSERT INTO [student_table]  ([firstname], [surname], [dob], [gender], [nationality], 
                           [mobile], [address], [parent_firstname],[parent_surname],[image], [email]) VALUES 
                           (@emp_fname, @emp_sname, @dob, @address, @phone, @email, @job_title, @hostel_id)"
            SelectCommand="Select * from student_table;"
            UpdateCommand="UPDATE [emp_table] SET emp_fname=@emp_sname, dob=@dob, address=@address, phone=@phone, email=@email, Hostel_name=@Hostel_name Where Hostel_Table.Hostel_id=emp_table.hostel_id AND employee_id=@employee_id"
            DeleteCommand="DELETE FROM [emp_table] WHERE [employee_id]=@employee_id"> 
             ...
             <UpdateParameters>
                 <asp:Parameter Name="emp_fname" Type="int32"/>
                 <asp:Parameter Name="emp_sname" Type="string"/>
                 <asp:Parameter Name="dob" Type="string"/>       
                 <asp:Parameter Name="address" Type="int32"/>
                 <asp:Parameter Name="phone" Type="string"/>
                 <asp:Parameter Name="email" Type="string"/> 
                 <asp:Parameter Name="job_title" Type="string"/>
                 <asp:Parameter Name="Hostel_name" Type="int32"/> 
    ...
    <br/><br/>
    <asp:GridView ID="gvStud" runat="server"  DataSourceID="dsAddEmployee" AllowPaging="true" CssClass="table table-striped" OnPreRender="gvEmp_PreRender"
         PageSize="15" AllowSorting="true" AutoGenerateColumns="false" GridLines="Horizontal" DataKeyNames="employee_id">
        <Columns>
            <asp:Boundfield HeaderText="stud_id" DataField="student_id" SortExpression="student_id"/> 
            ...
            <asp:Boundfield HeaderText="Sex" DataField="gender" SortExpression="gender"/> 
            <asp:Boundfield HeaderText="Nationality" DataField="nationality" SortExpression="nationality"/>  
            <asp:Boundfield HeaderText="Phone" DataField="mobile" SortExpression="mobile"/> 
            ...
            <asp:HyperLinkField HeaderText="view details" dataTextfield="stud_id" DataNavigateUrlFields="student_id" DataNavigateUrlFormatString="~/StudDetails.aspx?studId={0}" ItemStyle-Width = "150" />
            </Columns>
